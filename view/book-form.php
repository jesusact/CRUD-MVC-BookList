...
<div class="container-edit">
    ...
    <input type="text" name="bookTitle" value="<?php echo htmlentities($bookTitle); ?>">
    <br>
    <label for="author">Author: </label><br>
    <input type="text" name="author" value="<?php echo htmlentities($author); ?>">
    <br>
    <label for="editorial">Editorial: </label><br>
    <input type="text" name="editorial"><?php echo htmlentities($editorial); ?>
    <br>
    <label for="pages">Num of pages: </label><br>
    <input type="number" name="pages"><?php echo htmlentities($pages); ?>
    <br>
    <div class="buttons-edit">

    <input type="hidden" name="form-submitted" value="1">
    <input type="submit" value="Submit" id="update-btn">
